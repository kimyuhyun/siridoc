...
(function ($) {
    ...
    w2grid.prototype = {
        ...
        buttons: {
            ...
            'search-go': { type: 'drop',  id: 'w2ui-search-advanced', icon: 'w2ui-icon-search', text: '검색', tooltip: 'Open Search Fields' },
            'add'      : { type: 'button', id: 'w2ui-add', text: '등록', tooltip: 'Add new record', icon: 'w2ui-icon-plus' },
            'edit'     : { type: 'button', id: 'w2ui-edit', text: '수정', tooltip: 'Edit selected record', icon: 'w2ui-icon-pencil', disabled: true },
            'delete'   : { type: 'button', id: 'w2ui-delete', text: '삭제', tooltip: 'Delete selected records', icon: 'w2ui-icon-cross', disabled: true },
            'save'     : { type: 'button', id: 'w2ui-save', text: '저장', tooltip: 'Save changed records', icon: 'w2ui-icon-check' }
        },
            ...
            switch (this.type) {
                ...
                case 'file':
                    ...
                    if ($(this.el).attr('placeholder') == null) {
                        $(this.el).attr('placeholder', w2utils.lang('파일을 Drag 하여 올려 놓거나, Click하여 선택'));
                    }
                    this.addMulti();
                    this.watchSize();
                    break;
        ...
        generateHTML: function () {
            ...
            for (var p = 0; p < pages.length; p++){
                ...
                for (var c = 0; c < pages[p].length; c++){
                    ...
                    html += '<div style="width: 100%;" class="w2ui-column col-'+ c +'">' + (pages[p][c] || '') + '\n</div>';
                }
                html += '\n</div></div>';
            }
            html += buttons;
